...
class ParquetClassificacaoBaseRepository(IClassificacaoRepository):
    ...
    def _row_to_entity(self, row: pd.Series, temporada: Optional[str] = None) -> ClassificacaoBase:
    ...
    def get_by_posicao(self, posicao: int, temporada: Optional[str] = None) -> Optional[ClassificacaoBase]:
    ...
    def get_by_time(self, nome_time: str, temporada: Optional[str] = None) -> Optional[ClassificacaoBase]:
