...
class ClassificacaoController:
    ...
    def listar_classificacao(
        self, temporada: str = "2026", zona: Optional[str] = None
    ) -> Dict:
        """
    ...
    def _filtrar_por_zona(self, zona: str, temporada: str) -> List[Classificacao]:
    ...
    def get_vagas(self, temporada: str = "2026") -> Dict:
        ...
        return {"success": True, "data": vagas_config.to_dict()}
